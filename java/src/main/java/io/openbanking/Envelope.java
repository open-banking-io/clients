 ...
 *
 * <p>Scheme: ephemeral ECDH on NIST P-256 -&gt; HKDF-SHA256 -&gt; AES-256-GCM.
 * Wire: {@code version(1)=0x01 | ephemeralPublicKeyRaw(65) | nonce(12) | tag(16) | ciphertext}.
...
final class Envelope {
    ...
    static <T> T decryptTo(java.security.interfaces.ECPrivateKey privateKey, String envelopeB64,
    ...
    private static PublicKey importRawPublicKey(java.security.interfaces.ECPrivateKey privateKey, byte[] raw)
            throws Exception {
